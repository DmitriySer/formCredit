    ...
    <div class="container">
        <div class="row">
            <div class="col-6 col-md-5 shadow-sm p-3 mb-5 bg-body rounded border border-warning">
                ...
                <?php if ($_SESSION['thanks']) {
                    echo '<h3 style="color: darkgreen">' . $_SESSION['thanks'] . '</h3>';
                }
                unset($_SESSION['thanks']); ?>
                <form action="vendor/log.php" method="POST" class="needs-validation" novalidate>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">ФИО</label>
                        <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Введите как указано в паспорте" required>
                    ...
                    <div class="input-group mb-2">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" name="serPass" id="exampleInputEmail1" maxlength="4" placeholder="серия" required>
                            <input type="text" class="form-control" name="numPass" id="exampleInputEmail1" maxlength="6" placeholder="номер" required>
